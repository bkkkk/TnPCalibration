...
public:
  ...
  virtual bool EF_mu6_Trk_Jpsi_loose() const = 0;        
  virtual bool EF_mu6() const = 0;
  virtual bool EF_mu15() const = 0;
  virtual bool EF_mu8() const = 0;
  virtual bool EF_mu4T() const = 0;
