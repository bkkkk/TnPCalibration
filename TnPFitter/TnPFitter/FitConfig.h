...
class FitConfig {
public:
    FitConfig(std::string compositeFunction,
    ...
    std::string GetCompositeFunction();
...
private:
  ...
  ClassDef(FitConfig, 1)
    ...
    void SetCompositeFitFunction(std::string const &function);
};
